  ...
  ### Part 1의 사전 준비 사항    
  * (필수) [webMethods.io Integration - Free Trial 신청](/SoftwareAG-Korea/tutorials/blob/master/wM-UserGroup/Dec-2019/Prerequisite/README.preq1.md)  
  * (필수) [Saleforce Developer Free Trial](/SoftwareAG-Korea/tutorials/blob/master/wM-UserGroup/Dec-2019/Prerequisite/README.preq2.md)  
  * (필수) [Saleforce에서 ConnectedApp 생성](/SoftwareAG-Korea/tutorials/blob/master/wM-UserGroup/Dec-2019/Prerequisite/README.preq3.md)  
  * (옵션) [Postman으로 access token과 refresh token 받기](/SoftwareAG-Korea/tutorials/blob/master/wM-UserGroup/Dec-2019/Prerequisite/README.preq4.md)  
